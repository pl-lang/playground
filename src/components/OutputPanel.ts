...
export default class {
    ...
    create_title_bar() {
        ...
        this.step_button = $('<button class="green-button icon-button"><span class="octicon octicon-triangle-right"></span></button>')
        this.stop_button = $('<button class="red-button icon-button"><span class="octicon octicon-primitive-square"></span></button>')
